...
$.src="//v2.zopim.com/?38JzAmpOPUIJCyabsoasoMzjekRATHlQ";z.t=+new Date;$.
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&appId=1456782314614957&version=v2.0";
	...
	<div id="page">
		...
		<!-- Container -->
			<div id="container">
				...
				<div class="container">
					<?php if (!empty($error)) { ?>
					<div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme437/image/close-1.png" alt="" class="close" /></div>
					<?php } ?>
