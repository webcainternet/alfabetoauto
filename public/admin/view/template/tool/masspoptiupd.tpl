...
<div id="content">
  ...
  <div class="box">
	...
	<?php } ?>
    	...
    	<tr>
    	  <td colspan="2">
    	  <h3><?php echo $masstxt_p_options_updates; ?></h3>
    	  </td>
    	</tr>
    	</thead>
    	...
    	<tbody>
     	...
     	<tr>
    	  ...
    	  <?php echo $masstxt_load_existing_options; ?>
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_id]" value="" />
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  <td class="left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]">
                    ...
                    <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][product_option_value_id]" value="" /></td>
    	...
    	<tr>
    	  ...
    	  <?php echo $masstxt_options_update_mode; ?><br />
    	  ...
    	  <?php echo $masstxt_options_values_update_mode; ?><br />
    	...
    	<tr>
    	  ...
    	  <span class="help"><?php echo $masstxt_example1; ?></span>
...
$('input[name=\'filter_namex\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('input[name=\'product_id_to_options\']').val(ui.item.value2);
