  ...
  <div class="box">
	...
	<?php } ?>
    	...
    	<tr>
    	  ...
    	  <div style="float:left;border:1px solid #333;padding:4px;margin-right:6px;">
    	  <strong><?php echo $masstxt_p_updates_l; ?></strong> <input size="10" type="text" value="<?php echo $len_upd; ?>" name="len_upd">
    	  <span style="color:#666666;font-size:11px;">&nbsp;<?php echo $masstxt_leave_empty_to_not_upd; ?></span>
    	  <br />
    	  ...
    	  <div style="float:left;border:1px solid #333;padding:4px;">
    	...
    	<tr>
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_no_update_l_class_help; ?></span>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  ...
    	  <div style="border:1px solid #333;padding:4px;float:left;">
    	  <?php echo $masstxt_p_updates_value; ?> <input size="16" type="text" value="<?php echo $weight_upd; ?>" name="weight_upd">
    	  <span style="color:#666666;font-size:11px;">&nbsp;<?php echo $masstxt_leave_empty_to_not_upd; ?></span>
    	  <br />
    	  <?php echo $masstxt_update_mode; ?> 
    	...
    	<tr>
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_no_update_w_class_help; ?></span>
    	  </td>
    	</tr>
	  ...
	  <?php echo $masstxt_mass_update_examples; ?>
    	  </td>
    	</tr>
