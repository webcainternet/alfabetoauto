...
class ControllerToolmasspdwupd extends Controller { 
	...
	public function index() {
		...
		$this->data['masstxt_p_updates_dimensions'] = $this->language->get('masstxt_p_updates_dimensions');
		$this->data['masstxt_p_updates_l'] = $this->language->get('masstxt_p_updates_l');
		$this->data['masstxt_p_updates_w'] = $this->language->get('masstxt_p_updates_w');
		$this->data['masstxt_p_updates_h'] = $this->language->get('masstxt_p_updates_h');
		$this->data['masstxt_p_updates_length_class'] = $this->language->get('masstxt_p_updates_length_class');
		$this->data['masstxt_p_updates_weight'] = $this->language->get('masstxt_p_updates_weight');
		$this->data['masstxt_p_updates_value'] = $this->language->get('masstxt_p_updates_value');
		$this->data['masstxt_p_updates_weight_class'] = $this->language->get('masstxt_p_updates_weight_class');
		...
		$this->data['masstxt_leave_empty_to_not_upd'] = $this->language->get('masstxt_leave_empty_to_not_upd');
		$this->data['masstxt_no_update_l_class_help'] = $this->language->get('masstxt_no_update_l_class_help');
		$this->data['masstxt_no_update_w_class_help'] = $this->language->get('masstxt_no_update_w_class_help');
		...
		$this->data['masstxt_mass_update_examples'] = $this->language->get('masstxt_mass_update_examples');
		...
		if (isset($this->request->post['filter_attr'])) {
    		...
    		if (isset($this->request->post['len_upd_mode'])) {
      			$this->data['len_upd_mode'] = $this->request->post['len_upd_mode'];
		} else {
      			$this->data['len_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['len_upd'])) {
      			$this->data['len_upd'] = $this->request->post['len_upd'];
		} else {
      			$this->data['len_upd'] = '';
    		}
    		...
    		if (isset($this->request->post['wid_upd_mode'])) {
      			$this->data['wid_upd_mode'] = $this->request->post['wid_upd_mode'];
		} else {
      			$this->data['wid_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['wid_upd'])) {
      			$this->data['wid_upd'] = $this->request->post['wid_upd'];
		} else {
      			$this->data['wid_upd'] = '';
    		}
    		...
    		if (isset($this->request->post['hei_upd_mode'])) {
      			$this->data['hei_upd_mode'] = $this->request->post['hei_upd_mode'];
		} else {
      			$this->data['hei_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['hei_upd'])) {
      			$this->data['hei_upd'] = $this->request->post['hei_upd'];
		} else {
      			$this->data['hei_upd'] = '';
    		}

    		if (isset($this->request->post['weight_upd_mode'])) {
      			$this->data['weight_upd_mode'] = $this->request->post['weight_upd_mode'];
		} else {
      			$this->data['weight_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['weight_upd'])) {
      			$this->data['weight_upd'] = $this->request->post['weight_upd'];
		} else {
      			$this->data['weight_upd'] = '';
    		}

		if (isset($this->request->post['length_class_id_upd'])) {
      			$this->data['length_class_id_upd'] = $this->request->post['length_class_id_upd'];
		} else {
      			$this->data['length_class_id_upd'] = 'no-update';
    		}
    		
		if (isset($this->request->post['weight_class_id_upd'])) {
      			$this->data['weight_class_id_upd'] = $this->request->post['weight_class_id_upd'];
		} else {
      			$this->data['weight_class_id_upd'] = 'no-update';
    		}
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		'href'      => $this->url->link('tool/masspdwupd', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('tool/masspdwupd', 'token=' . $this->session->data['token'], 'SSL');

		$this->template = 'tool/masspdwupd.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
