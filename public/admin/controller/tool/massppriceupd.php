...
class ControllerToolmassppriceupd extends Controller { 
	...
	public function index() {
		...
		$this->data['masstxt_p_updates_price'] = $this->language->get('masstxt_p_updates_price');
		$this->data['masstxt_p_updates_value'] = $this->language->get('masstxt_p_updates_value');
		$this->data['masstxt_no_update_price_help'] = $this->language->get('masstxt_no_update_price_help');
		$this->data['masstxt_p_updates_tax_class'] = $this->language->get('masstxt_p_updates_tax_class');
		$this->data['masstxt_no_update_tax_class_help'] = $this->language->get('masstxt_no_update_tax_class_help');
		...
		$this->data['masstxt_upd_price_addition_help'] = $this->language->get('masstxt_upd_price_addition_help');
		$this->data['masstxt_upd_price_subtraction_help'] = $this->language->get('masstxt_upd_price_subtraction_help');
		$this->data['masstxt_upd_price_multiplication_help'] = $this->language->get('masstxt_upd_price_multiplication_help');
		$this->data['masstxt_upd_price_replacement_help'] = $this->language->get('masstxt_upd_price_replacement_help');
		...
		if (isset($this->request->post['price_val_upd'])) {
      			$this->data['price_val_upd'] = $this->request->post['price_val_upd'];
		} else {
      			$this->data['price_val_upd'] = '';
    		}

		if (isset($this->request->post['tax_class_upd'])) {
      			$this->data['tax_class_upd'] = $this->request->post['tax_class_upd'];
		} else {
      			$this->data['tax_class_upd'] = 'no-update';
    		}
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		'href'      => $this->url->link('tool/massppriceupd', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('tool/massppriceupd', 'token=' . $this->session->data['token'], 'SSL');

		$this->template = 'tool/massppriceupd.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
