...
class ControllerToolmasspfiltersupd extends Controller { 
	...
	public function index() {
		...
		// filters updates
		$this->data['masstxt_p_filters_updates'] = $this->language->get('masstxt_p_filters_updates');
		$this->data['masstxt_new_filters'] = $this->language->get('masstxt_new_filters');
		...
		if (isset($this->request->post['filters_ids_upd'])) {
			$this->data['filters_ids_upd'] = $this->request->post['filters_ids_upd'];
		} else {
			$this->data['filters_ids_upd'] = array();
		}
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		'href'      => $this->url->link('tool/masspfiltersupd', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('tool/masspfiltersupd', 'token=' . $this->session->data['token'], 'SSL');

		$this->template = 'tool/masspfiltersupd.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
